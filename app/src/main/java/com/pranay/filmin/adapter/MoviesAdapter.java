package com.pranay.filmin.adapter;
...
import com.pranay.filmin.databinding.SingleMovieItemBinding;
...
public class MoviesAdapter extends PagingDataAdapter<Movie,MoviesAdapter.MovieViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MovieViewHolder holder, int position) {
        ...
        if(currentMovie != null){
            glide.load("https://image.tmdb.org/t/p/w500"+currentMovie.getPosterPath()).into(
                    holder.movieItemBinding.imageViewMovie);
